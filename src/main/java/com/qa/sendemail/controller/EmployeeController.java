...
public class EmployeeController {
	...
	@PostMapping("/emailVerify/getters/sendEmail/sendCreateEmployee")
	public void createEmployeeEmail(@RequestBody Employee employee) {
		service.sendSimpleMessage(employee.getEmail() + ".com", "RMS Account Created",
				cons.createEmployeeMail(employee.getForename(), employee.getLastname()));
	}
